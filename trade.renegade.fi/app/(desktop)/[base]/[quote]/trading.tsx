        ...
        <>
            ...
            >
                <Flex
                    ...
                    flexDirection="column"
                    transform={
                        baseTokenAmount ? "translateY(-15px)" : (
                            "translateY(10px)"
                        )
                    }
                    transition="0.15s"
                >
                    <HStack fontFamily="Aime" fontSize="1.8em" spacing="20px">
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setBaseTokenAmount(parseFloat(e.target.value))
                            }
                            onFocus={(e) =>
    ...
    return (
        ...
        >
            <Text marginRight="4px">
                Trades are end-to-end encrypted and always clear at the
                real-time midpoint of ${usdPrice}
            </Text>
        </HStack>
    )
}
