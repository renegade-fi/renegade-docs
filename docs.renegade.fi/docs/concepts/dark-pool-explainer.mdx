...
slug: /concepts/dark-pool-explainer
---
...
MPC](./mpc-explainer) and [The MPC-ZKP
Architecture](./mpc-zkp), and to see precisely is meant by
"end-to-end privacy", see [Privacy Guarantees](./privacy).
