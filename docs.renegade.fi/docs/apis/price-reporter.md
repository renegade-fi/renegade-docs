...
|-|-|-|
| Mainnet     | <CopyableValue value="https://mainnet.price-reporter.renegade.fi:3000" /> | <CopyableValue value="wss://mainnet.price-reporter.renegade.fi:4000" /> |
| Testnet     | <CopyableValue value="https://testnet.price-reporter.renegade.fi:3000" /> | <CopyableValue value="wss://testnet.price-reporter.renegade.fi:4000" /> |
...
Error messages are returned as plain text. The message will describe the issue,
such as an invalid topic format, unsupported token, or internal server error.
...
| ----------- | ----------------------------------------------- |
| Mainnet     | <CopyableValue value="wss://mainnet.price-reporter.renegade.fi:4000" /> |
| Testnet     | <CopyableValue value="wss://testnet.price-reporter.renegade.fi:4000" /> |
