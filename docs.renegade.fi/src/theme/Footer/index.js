    ...
    <div className={styles.footer}>
      <div className={styles.footerTextWrapper}>
        <div className={styles.footerText}>
          <p className={styles.footerTextQuestion}>Questions?</p>
        ...
        <div className={styles.footerText}>
          <p className={styles.footerTextQuestion}>Need some Inspiration?</p>
          <p className={styles.footerTextAnswer}>
            Read{" "}
            <a
              href="https://satoshi.nakamotoinstitute.org/quotes/"
              target="_blank"
              rel="noreferrer"
            >
